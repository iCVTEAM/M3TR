...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        q_sem, k_sem, v_sem = qkv_sem[0], qkv_sem[1], qkv_sem[2]
        q_embed, k_embed, v_embed = qkv_embed[0], qkv_embed[1], qkv_embed[2]

        # inter-modal: Linguistic Cross-Attention
        ...
        # intra-modal: Semantic Cross-Attention
